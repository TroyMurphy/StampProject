...
OUTPUT_FILE_PATH="output/d45.pdf"
sizes={
        "None":(0,0),
        "A":(8.5,11),
        "B":(11,17),
...
coverPage=copyCover1.createCoverPage("FILE COPY","This is file copy")
...
coverPage=copyCover2.createCoverPage("FOREMAN COPY","This is the foreman copy")
...
outputPdf=pdf.stampPages(outputPages,stamps2,xPercentOffset=0.1,yPercentOffset=0.15,offset=0)
#
# ################################################################################################################
# #STEP 1) List criteria to search for and filter correctly
# #############################################
